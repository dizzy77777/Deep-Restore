...
if __name__ == '__main__':
    ...
    for layer in range(0, layers):
        ...
        dw_h_convs[layer] = tf.nn.relu(conv1_bn + b1)
        ...
        dw_h_convs_test[layer] = tf.nn.relu(conv1_test_bn + b1)
    ...
    loss_sum = tf.summary.scalar("cross_entropy_early", loss_test)
    ...
    accuracy_sum = tf.summary.scalar("accuracy_early", accuracy_test)
