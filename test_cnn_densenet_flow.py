...
if __name__ == '__main__':
    ...
    for layer in range(0, layers):
        current_act = tf.nn.relu if layer < layers - 1 else None 
        conv1 = tf.layers.conv2d(in_node, features, (filter_size, filter_size), padding='same', activation=current_act)
