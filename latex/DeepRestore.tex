...
\subsection{Perona-Malik In-painting}
\label{ssec:num42}
...
\begin{tabular}{ c c c c c c c}
 ...
 \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests0/input.png} & \setlength{\fboxrule}{0.5pt}
        \setlength{\fboxsep}{0pt}\framebox{\includegraphics[width=.13\linewidth, decodearray={1 0 1 0 1 0}]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests0/GT_mask.png}} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests0/GT_out.png} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests0/pred_out.png}& \includegraphics[width=.13\linewidth]{results_painting/densenet/loss_and_acc_over_mask_densenet/cnn_tests_restore/cnn_tests0/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/densenet/results_paths_3_mask/cnn_tests_restore/cnn_tests0/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/pm/results/results0/res_diffusion.png} \\
    \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests3/input.png} & \setlength{\fboxrule}{0.5pt}
        \setlength{\fboxsep}{0pt}\framebox{\includegraphics[width=.13\linewidth, decodearray={1 0 1 0 1 0}]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests3/GT_mask.png}} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests3/GT_out.png} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests3/pred_out.png}& \includegraphics[width=.13\linewidth]{results_painting/densenet/loss_and_acc_over_mask_densenet/cnn_tests_restore/cnn_tests3/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/densenet/results_paths_3_mask/cnn_tests_restore/cnn_tests3/pred_out.png} &\includegraphics[width=.13\linewidth]{results_painting/pm/results/results3/res_diffusion.png} \\
     \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests5/input.png} & \setlength{\fboxrule}{0.5pt}
        \setlength{\fboxsep}{0pt}\framebox{\includegraphics[width=.13\linewidth, decodearray={1 0 1 0 1 0}]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests5/GT_mask.png}} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests5/GT_out.png} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests5/pred_out.png}& \includegraphics[width=.13\linewidth]{results_painting/densenet/loss_and_acc_over_mask_densenet/cnn_tests_restore/cnn_tests5/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/densenet/results_paths_3_mask/cnn_tests_restore/cnn_tests5/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/pm/results/results5/res_diffusion.png} \\
       \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests7/input.png} & \setlength{\fboxrule}{0.5pt}
        \setlength{\fboxsep}{0pt}\framebox{\includegraphics[width=.13\linewidth, decodearray={1 0 1 0 1 0}]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests7/GT_mask.png}} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests7/GT_out.png} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests7/pred_out.png}& \includegraphics[width=.13\linewidth]{results_painting/densenet/loss_and_acc_over_mask_densenet/cnn_tests_restore/cnn_tests7/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/densenet/results_paths_3_mask/cnn_tests_restore/cnn_tests7/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/pm/results/results7/res_diffusion.png} \\
        \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests9/input.png} & \setlength{\fboxrule}{0.5pt}
        \setlength{\fboxsep}{0pt}\framebox{\includegraphics[width=.13\linewidth, decodearray={1 0 1 0 1 0}]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests9/GT_mask.png}} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests9/GT_out.png} & \includegraphics[width=.13\linewidth]{results_painting/unet/loss_and_acc_over_mask_unet/cnn_tests_restore/cnn_tests9/pred_out.png}& \includegraphics[width=.13\linewidth]{results_painting/densenet/loss_and_acc_over_mask_densenet/cnn_tests_restore/cnn_tests9/pred_out.png} &
 \includegraphics[width=.13\linewidth]{results_painting/densenet/results_paths_3_mask/cnn_tests_restore/cnn_tests9/pred_out.png} & \includegraphics[width=.13\linewidth]{results_painting/pm/results/results9/res_diffusion.png} \\
 (a) Input & (b) Mask & (c) GT & (d)  U-Net & (e) Densenet & (f) \makecell{Densenet\\paths} & (g) \makecell{Perona-\\Malik}
\end{tabular}

\captionof{figure}{Sample results of image in-painting for U-Net (Figure~\ref{fig:paint_unet}), Densenet (Figure~\ref{fig:paint_densenet}), Densenet paths (Figure~\ref{fig:paint_densenet2}) and Perona-Malik (Section~\ref{ssec:num42}).}
%\caption{Comparison of thermal efficiency of Present study with O. Kaska []}
\label{fig:resu_pm}
\end{center}\end{table}
